...
export class MatchContextFactor implements S24FactorModule {
  readonly key = 'matchContext' as const;
  readonly label = 'Contexto del Partido';
...
export const matchContextFactor = new MatchContextFactor();

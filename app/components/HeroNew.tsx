...
export default function HeroNew() {
  return (
    <section className="w-full bg-black relative overflow-hidden px-8 md:px-12 pt-24 pb-0 md:pt-24 md:pb-5">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-[1.02fr_1.38fr] gap-6 lg:gap-7 items-center">
          <div className="min-w-0 space-y-6 md:space-y-6">
            <h1 className="text-[2.3rem] sm:text-[3.7rem] md:text-[4.3rem] font-bold text-white leading-[0.98] md:leading-[0.98] tracking-tight max-w-[640px]">
              <span className="block md:hidden">
                <span className="block whitespace-nowrap">La plataforma líder</span>
                <span className="block whitespace-nowrap">en</span>
                <span className="block whitespace-nowrap text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-600">Inteligencia</span>
                <span className="block whitespace-nowrap text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-600">Deportiva</span>
              </span>
            ...
            <div className="relative h-[280px] flex items-center justify-center lg:hidden">
              <div className="absolute inset-0 flex items-center justify-center">
                ...
                <div className="absolute w-72 h-72 bg-blue-500/24 rounded-full blur-3xl" />
              </div>
              <img
            ...
            <div className="flex flex-col gap-3.5 pt-1 md:flex-row">
              <Link href="/analisis" className="min-w-0 flex-1 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white font-semibold h-12 md:h-12 px-5 md:px-7 rounded-xl text-base transition-all shadow-[0_10px_28px_rgba(37,99,235,0.38)] flex items-center justify-center gap-2 whitespace-nowrap">
                Ver análisis de hoy
                <span>→</span>
              </Link>
              <Link href="/match" className="min-w-0 flex-1 border border-blue-500/65 bg-blue-500/5 text-blue-300 hover:bg-blue-500/15 font-semibold h-12 md:h-12 px-5 md:px-7 rounded-xl text-base transition-colors flex items-center justify-center gap-2 whitespace-nowrap">
                Explorar partidos
                <span>→</span>
              </Link>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-2 max-w-2xl pt-1">
          ...
          <div className="relative hidden h-[430px] items-center justify-center lg:flex lg:h-[470px]">
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="absolute w-[99%] h-[95%] rounded-[24px] border border-blue-500/25 bg-gradient-to-br from-blue-500/8 via-transparent to-blue-700/18 backdrop-blur-sm" />
